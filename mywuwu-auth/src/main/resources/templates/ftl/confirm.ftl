    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-5">
            <p class="navbar-text navbar-right">
                <a target="_blank" href="https://ywuwu.com">技术支持</a>
            </p>
            <p class="navbar-text navbar-right">
                <a target="_blank" href="https://ywuwu.com">${user.username}</a>
            </p>
        </div>
    </div>
</nav>
...
<footer>
    <p>support by: ywuwu.com</p>
    <p>email: <a href="mailto:lianglele1986@126.com">lianglele1986@126.com</a>.</p>
</footer>
</body>
</html>
